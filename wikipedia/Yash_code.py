...
class GraphGenerator:
	def main(self):
		...
		#Import CSV file
		dataframe = pandas.read_csv('AlgoWiki Algorithms - Time Complexity.csv')
		dataframe = dataframe.loc[(dataframe['Quantum?'] == 0) & (dataframe['Parallel?'] == 0) & (dataframe['Exact?'] == 1) & (dataframe['Randomized?'] == 0) & (dataframe['Approximate?'] == 0) & (dataframe['GPU-based?'] == 0)]
