...
def clean_data():
    ...
    """
    dataframe = pd.read_csv('/Users/bellasteedly/Library/Mobile Documents/com~apple~CloudDocs/AlgorithmsWiki/Hayden_Figures/wiki_data_dirty.csv')
    ...
    while searching:
        ...
        if not found:
            ...
            found = False
    dataframe.to_csv('/Users/bellasteedly/Library/Mobile Documents/com~apple~CloudDocs/AlgorithmsWiki/Hayden_Figures/wiki_data.csv')
    return dataframe
...
def get_variations(family):
    ...
    """
    dataframe = pd.read_csv('/Users/bellasteedly/Library/Mobile Documents/com~apple~CloudDocs/AlgorithmsWiki/Hayden_Figures/wiki_data.csv')
    dataframe = dataframe.replace(np.nan, '', regex=True)
...
def get_best_space(algorithms):
    ...
    for index, row in algorithms.iterrows():
        ...
        print(row['Space Complexity Class'])
